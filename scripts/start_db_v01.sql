...
--
-- Host: localhost    Database: office_robot_db
-- ------------------------------------------------------
...
CREATE TABLE `Robot_Telemetry_Logs` (
  ...
  `status` enum('IDLE','ASSIGNED','MOVING','GUIDING','CHARGING','ERROR') DEFAULT NULL,
...
CREATE TABLE `Robots` (
  ...
  `battery_level` int DEFAULT NULL COMMENT '배터리 잔량 % (SR-010, SR-017)',
...
CREATE TABLE `Tasks` (
  ...
  `task_type` enum('GUIDE','SNACK_DELIVERY','ITEM_DELIVERY','RETURN') DEFAULT NULL,
...
CREATE TABLE `Users` (
  ...
  PRIMARY KEY (`user_id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='내부 직원 정보 관리 (SR-009)';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `Users` VALUES (3,'관리자','운영팀','ADMIN',NULL,'2026-02-12 07:44:48','1234','admin'),(4,'스태프1','기술팀','STAFF',NULL,'2026-02-12 07:44:48','1234','staff');
...
-- Dump completed on 2026-02-20 17:31:39
