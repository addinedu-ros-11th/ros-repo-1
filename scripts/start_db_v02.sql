...
-- Schema based on start_db.sql (updated)
...
INSERT INTO `Users` (`user_id`, `account`, `password_hash`, `name`, `department`, `role`, `app_token`, `created_at`) VALUES 
(1, 'admin', '1234', '관리자', '운영팀', 'ADMIN', NULL, NOW()),
(2, 'staff', '1234', '스태프1', '기술팀', 'STAFF', NULL, NOW()),
(3, 'alice', '1234', '앨리스', '인사팀', 'STAFF', NULL, NOW()),
(4, 'bob', '1234', '밥', '개발팀', 'STAFF', NULL, NOW());
